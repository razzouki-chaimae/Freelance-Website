          ...
          <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#">Drop Down 4</a></li>
				...
				<li><a class="nav-link scrollto" href="/freelanceProject#faq">FAQ</a></li>
				<li><a class="nav-link scrollto"
					href="/freelanceProject#contact">Contact</a></li>
				<li><a class="getstarted scrollto"
					href="/freelanceProject/VUE/Login.jsp">Se connecter</a></li>
			</ul>
